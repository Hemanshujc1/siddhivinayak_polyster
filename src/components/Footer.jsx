      ...
      <div className="container mx-auto px-4 md:px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 flex items-center justify-center">
                <img src={siddhiLogo} alt="Siddhi-Vinayak-polyster-logo" className="w-full h-full object-contain" />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-xl text-white leading-none">
                  Siddhi Vinayak
                </span>
                <span className="text-[10px] text-accent-light font-semibold tracking-[0.2em] mt-0.5">
                  POLYESTER
                </span>
              </div>
            </div>
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">
              With 15 years of excellence, Siddhi Vinayak Polyester is a leading
              B2B polyester yarn manufacturer and trader serving domestic and
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-sm hover:text-accent-light transition-colors flex items-center gap-2"
                  >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">
                  <strong>Corp. Office:</strong> Mumbai, MH
                  <br />
                  <strong className="mt-1 block">Factories:</strong> Silvassa
                  (D&NH) & Vapi (GJ)
                </span>
              </li>
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Looking for bulk polyester yarn? Contact our sales team for
              competitive pricing.
            </p>
            <Link
              to="/quote"
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Siddhi Vinayak Polyester. All
            rights reserved.
          </p>
