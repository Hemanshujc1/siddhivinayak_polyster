      ...
      <div className="absolute inset-0 pointer-events-none opacity-20 hidden md:block">
        ...
        >
          ...
          <motion.path 
            ...
            transition={{ duration: 7, ease: "easeInOut", repeat: Infinity, repeatType: "reverse", repeatDelay: 1 }}
          />
          <motion.path 
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-primary-dark mb-3 leading-tight">
              Source Premium <span className="text-accent">Polyester Yarns</span> Directly
            </h1>
            <p className="text-base text-neutral-dark mb-5 max-w-2xl leading-relaxed">
              Leading manufacturers of high-performance DTY combined with direct mill dispatches for POY and FDY. Get the best pricing for your weaving and knitting units.
            </p>
            ...
            <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-gray-150 max-w-2xl mb-4">
              <h2 className="text-xs font-bold text-accent uppercase tracking-widest mb-1.5">B2B Sourcing Hub</h2>
              <h3 className="text-lg font-extrabold text-primary-dark mb-3">Fast-Track Your Procurement</h3>
            ...
            <div className="flex items-center gap-2 text-xs font-semibold mb-6">
              <span className="text-gray-400">Not sure about specifications?</span>
              <Link 
                to="/learning" 
          ...
          >
            <div className="flex flex-col">
              <span className="text-xl font-extrabold text-primary-dark">DTY</span>
              <span className="text-xs text-gray-500 font-medium">In-House Production</span>
            </div>
            <div className="w-px h-8 bg-gray-300"></div>
            <div className="flex flex-col">
              <span className="text-xl font-extrabold text-primary-dark">POY & FDY</span>
              <span className="text-xs text-gray-500 font-medium">Authorized Channel Partner</span>
            </div>
            <div className="w-px h-8 bg-gray-300"></div>
            <div className="flex flex-col">
              <span className="text-xl font-extrabold text-primary-dark">20+</span>
              <span className="text-xs text-gray-500 font-medium">Years of Excellence</span>
            </div>
          </motion.div>
        </div>
      </div>
