...
import { Check, AlertTriangle, ArrowRight, X, Download, ArrowDown } from 'lucide-react';
...
const Poy = () => {
  ...
  const advantages = [
    { title: 'Lowest Price Point', desc: 'Being semi-finished, POY is significantly cheaper per kilogram — attractive for processors who can convert it themselves.' },
    { title: 'Flexible Processing', desc: 'Can be converted into DTY (textured), FDY (flat drawn), or ATY (air textured) — giving processors maximum output flexibility.' },
    { title: 'Excellent Draw Ratio', desc: 'The partially oriented structure allows significant stretching during texturizing, resulting in a strong, consistent final product.' },
    { title: 'Wide Denier Range', desc: 'From fine 75D microfilament to heavy 250D industrial grades — covers virtually all downstream manufacturing requirements.' },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="POY: The essential feed yarn for texturizing units. Traded from Reliance, Bhilosa, Wellknown. Full specs, advantages, and industry usage guide." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-3">POY — Partially Oriented Yarn</h1>
              <p className="text-blue-200 text-lg mb-6">The Essential Feed Yarn for Texturizing</p>
              <div className="flex flex-wrap gap-2 mb-8">
                {['75D – 250D', 'For Texturizing Units Only', 'SD / BR / FD'].map(t => (
            ...
            <div className="w-full md:w-72 space-y-3 shrink-0">
              <div className="bg-green-500/15 border border-green-400/30 rounded-xl p-4">
                ...
                <div className="flex flex-wrap gap-1">
                  {['DTY Manufacturing', 'Texturizing Units', 'Draw Warping', 'Industrial Processing'].map(v => (
              ...
              <div className="bg-red-500/15 border border-red-400/30 rounded-xl p-4">
                <div className="text-red-300 text-xs font-bold uppercase tracking-wider mb-2">✕ Not For</div>
                <div className="flex flex-wrap gap-1">
                  {['Garment factories', 'Knitting mills', 'Weaving units'].map(v => (
                    <span key={v} className="bg-white/10 text-white text-xs px-2 py-1 rounded-md">{v}</span>
                  ))}
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="w-full lg:w-40 h-40 rounded-xl overflow-hidden shadow-md border border-gray-200 shrink-0 bg-white">
              <img src="/images/products/poy-spool.png" alt="POY Yarn Bobbin" className="w-full h-full object-cover" />
            </div>
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-primary-dark mb-3">What is POY?</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Partially Oriented Yarn is the first form of yarn made by spinning polyester chips. The polymer chains are only "partially oriented" — the yarn is not yet stable enough for direct fabric production. It must be further processed into <Link to="/products/dty" className="text-accent font-bold hover:underline">DTY</Link> or <Link to="/products/fdy" className="text-accent font-bold hover:underline">FDY</Link>.
              </p>
            </div>
            <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm shrink-0 w-full lg:w-80">
              <h3 className="font-bold text-primary-dark mb-3 text-sm uppercase tracking-wider">Who buys POY?</h3>
              <ul className="space-y-2">
                {[
                  { label: 'DTY Manufacturers', desc: 'Convert POY into DTY.' },
                  { label: 'Texturizing Units', desc: 'Perform false-twist texturing.' },
                  { label: 'Draw Warping Units', desc: 'Convert POY into FDY.' },
                ].map(b => (
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          {activeTab === 1 && (
            <div className="max-w-lg mx-auto bg-neutral-light rounded-2xl p-6 border border-gray-100">
              <p className="text-xs text-gray-400 mb-4 text-center font-medium">POY is only for industrial processors — not direct fabric production</p>
          ...
          {activeTab === 3 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {['DTY Manufacturers', 'Texturizing Units', 'Draw Warping Units', 'Industrial Processors'].map(b => (
      ...
      <section className="py-10 bg-gradient-to-br from-primary to-primary-dark text-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-extrabold text-white mb-2">Why garment factories never buy POY directly</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
                POY lacks the tenacity for direct fabric use. It stretches unpredictably and snaps during weaving/knitting. It must first be texturized into DTY or drawn into FDY.
              </p>
            </div>
            <div className="flex flex-col gap-2 shrink-0">
              <Link to="/products/compare" className="text-blue-300 font-bold hover:text-white border border-blue-300/30 px-5 py-2.5 rounded-full text-sm text-center transition-colors">
                Compare All Yarns →
              </Link>
              <Link to="/yarn-finder" className="bg-accent hover:bg-accent-light text-white font-bold px-5 py-2.5 rounded-full text-sm text-center transition-all">
                Use Yarn Finder
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link to="/products/dty" className="group flex items-center gap-4 p-5 bg-white rounded-xl border border-gray-100 hover:border-accent hover:shadow-md transition-all">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-500 text-sm">The most common end product made from POY.</div>
              </div>
            ...
            <Link to="/products/fdy" className="group flex items-center gap-4 p-5 bg-white rounded-xl border border-gray-100 hover:border-accent hover:shadow-md transition-all">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-500 text-sm">Smooth, lustrous. Made by fully drawing POY.</div>
              </div>
              <ArrowRight className="text-gray-300 group-hover:text-accent transition-colors shrink-0" />
            </Link>
          </div>
